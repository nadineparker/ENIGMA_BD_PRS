...
## What operating system are you running this script on? PLEASE use "yes" or "no". LOWER CASE MATTERS!
...
export PLINK=/cluster/projects/p697/users/nadinepa/Tools/plink_linux/plink

## Path to downloaded Plink v2 executable file
export PLINK2=/cluster/projects/p697/users/nadinepa/ENIGMA/BD_PRS_PROJECT/plink2
