...
Download and unzip the ``ENIGMA_BD_PRS.zip`` directory from figshare (https://figshare.com/s/584d09eaf76a05d4f29f). All necessary project files are located in that directory. NOTE: some files are large, therefore, (1) this download will take time (hours) and (2) we recommend having ~25GB of free space on your system.
